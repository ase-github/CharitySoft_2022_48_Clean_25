...
Public Class allocate_donor
    ...
    Public Sub Fill_DDL()
        ...
        'Session(SessionName.USERNAME) = "sa"
        ...
        'DDL_DS = New DataSet
        'DDL_DS = WS.GetMyData("charitysoft", Session(SessionName.USERNAME), Session("password"), SQL)
        ...
        DDL_DS = New DataSet
        DDL_DS = WS.GetMyData("charitysoft", Session(SessionKey.USERNAME), Session("password"), SQL)
    ...
    Private Sub lnk_search_rtn_ServerClick(sender As Object, e As System.EventArgs) Handles lnk_search_rtn.ServerClick
        ...
        OrphanName_Ds = WS.GetMyData("charitysoft", Session(SessionKey.USERNAME), Session("password"), SQL)
        ...
        BenefMaster_DS = WS.ExecSpResultSet("charitysoft", Session(SessionKey.USERNAME), Session("password"), "GetDonorAllocate", ServiceReference.CommandType.StoredProcedure, BenefParam)
