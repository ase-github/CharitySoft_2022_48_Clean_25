<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCOrphanEducation.ascx.vb"
    Inherits="DirectAid.UCOrphanEducation" %>
        ...
        .dxWeb_pNextDisabled_Aqua
{
    ...
    height: 19px;
        ...
        .auto-style1 {
        border-width: 0;
        background-image: url('mvwres://DevExpress.Web.ASPxThemes.v13.1,%20Version=13.1.5.0,%20Culture=neutral,%20PublicKeyToken=b88d1754d700e49a/DevExpress.Web.ASPxThemes.App_Themes.Aqua.Editors.sprite.png');
    }
    .auto-style2 {
        border-width: 0;
