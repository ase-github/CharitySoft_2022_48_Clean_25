...
Public Class UCOrphanEducation
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dts_edu_hist.ConnectionString = New ConnectionStringEx().TheConnectionString
    ...
    Private Sub lnk_search_rtn_ServerClick(sender As Object, e As System.EventArgs) Handles lnk_search_rtn.ServerClick
        ...
        BenefMaster_DS = WS.ExecSpResultSet("charitysoft", Session("username"), Session("password"), "GetBenfMasterEducation", CommandType.StoredProcedure, BenefParam)
