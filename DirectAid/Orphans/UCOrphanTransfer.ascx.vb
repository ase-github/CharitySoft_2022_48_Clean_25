...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dts_transfer_orphan.ConnectionString = New ConnectionStringEx().TheConnectionString
    ...
    Private Sub lnk_search_rtn_ServerClick(sender As Object, e As System.EventArgs) Handles lnk_search_rtn.ServerClick
        ...
        If Me.ddl_benf_type.SelectedIndex = 0 Then
            BenefMaster_DS = WS.ExecSpResultSet("charitysoft", Session("username"), Session("password"), "GetOrphansTranfersLog", CommandType.StoredProcedure, BenefParam)
            ...
            End If
        Else
            BenefMaster_DS = WS.ExecSpResultSet("charitysoft", Session("username"), Session("password"), "GetStudentTranfersLog", CommandType.StoredProcedure, BenefParam)
