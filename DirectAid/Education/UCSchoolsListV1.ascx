<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCSchoolsListV1.ascx.vb" Inherits="DirectAid.UCSchoolsListV1" %>
...
from school_master
where school_related_to_da = 1"></asp:SqlDataSource>
