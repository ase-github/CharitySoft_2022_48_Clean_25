<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCSchoolsMasterIndependentV1.ascx.vb" Inherits="DirectAid.UCSchoolsMasterIndependentV1" %>
...
<script type="text/javascript">
    ...
    function createNew()
    {
        document.location.href = 'IndependentSchoolsMaster.aspx?t=New';
        document.URL
    }
                ...
                <tr>
                    ...
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 120px;">
                        <dx:ASPxComboBox ID="ddl_site_type" runat="server" DataSourceID="org_type_DS" DataTextField="org_type_ar"
                            ...
                            Height="23px" Width="150px" TextField="org_type_ar" ValueField="org_type_code" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Byte">
                        </dx:ASPxComboBox>
                    </td>
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 120px;">
                    ...
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 120px;">
                        <dx:ASPxComboBox ID="ddl_country_name" runat="server" AutoPostBack="True" ClientIDMode="Static"
                            ...
                            Font-Names="Tahoma" Font-Size="9pt" ForeColor="#000066" Height="23px" Width="150px" TextField="nat_descrar" ValueField="nat_code" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                        </dx:ASPxComboBox>
                    </td>
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 120px;">
                    ...
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 160px;">
                        <dx:ASPxComboBox ID="ddl_country_city" runat="server" AutoPostBack="True" Font-Names="Tahoma"
                            Font-Size="9pt" ForeColor="#000066" Height="23px" Width="150px" DataSourceID="cities_name" TextField="city_name_ar" ValueField="city_id" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                        </dx:ASPxComboBox>
                    </td>
                    <td dir="rtl" style="border: 1px none #FFFFFF; margin-right: 160px;">
                ...
                <tr>
                    ...
                    <td class="style81" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        <dx:ASPxComboBox ID="ddl_school_center" runat="server" DataSourceID="school_center_DS"
                            ...
                            Font-Size="9pt" ForeColor="#000066" Height="23px" Width="150px" TextField="center_namear" ValueField="center_code" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                        </dx:ASPxComboBox>
                    </td>
                    <td class="style81" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                    ...
                    <td class="style95" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        <dx:ASPxComboBox ID="DDL_school_language" runat="server" DataSourceID="language_DS"
                            ...
                            ForeColor="#000066" Height="23px" Width="150px" TextField="lang_descrar" ValueField="lang_code" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                        </dx:ASPxComboBox>
                    </td>
                    ...
                    <td class="style85" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        <dx:ASPxComboBox ID="ddl_school_category" runat="server" DataSourceID="school_category_DS"
                            ...
                            Font-Size="9pt" ForeColor="#000066" Height="23px" Width="150px" Visible="False" TextField="category_name_ar" ValueField="category_code" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                        </dx:ASPxComboBox>
                    </td>
                    <td class="style85" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        &nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="style81" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        <dx:ASPxComboBox ID="ddl_acad_year_start" runat="server"
                            ...
                            Font-Size="10pt" ForeColor="#000066" Height="23px" Width="150px" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                             <Items>
                    ...
                    <td class="style81" dir="rtl" style="border: 1px none #FFFFFF; margin-right: 40px;">
                        <dx:ASPxComboBox ID="ddl_acad_year_end" runat="server"
                            DataTextField="month_name_ar" DataValueField="month_code" Font-Names="Tahoma"
                            Font-Size="10pt" ForeColor="#000066" Height="22px" Width="150px" EnableCallbackMode="True" EnableClientSideAPI="True" IncrementalFilteringMode="Contains" ValueType="System.Int16">
                            <Items>
                                <dx:ListEditItem Value="1" Text="يناير"></dx:ListEditItem>
                                <dx:ListEditItem Value="2" Text="فبراير"></dx:ListEditItem>
                                <dx:ListEditItem Value="3" Text="مارس"></dx:ListEditItem>
