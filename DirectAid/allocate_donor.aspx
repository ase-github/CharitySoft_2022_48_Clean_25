<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="allocate_donor.aspx.vb"
    Inherits="DirectAid.allocate_donor" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width: 802px">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <table bgcolor="#F1F7FC" cellspacing="1" dir="rtl" style="width: 95%; height: 47px;
                    margin-right: 62px;">
                    <tr>
                        <td class="style50">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label226" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="الأسم" Width="54px"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style50">
                            <asp:Label ID="Label190" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="نوع العملية" Width="58px"></asp:Label>
                        </td>
                        <td class="style33">
                        ...
                        <td>
                            <asp:Label ID="Label194" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="التاريخ" Width="65px"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style50">
                            <asp:Label ID="Label192" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="السبب" Width="37px"></asp:Label>
                        </td>
                        <td class="style33">
                        ...
                        <td>
                            <asp:Label ID="Label193" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="اسم المتبرع" Width="58px"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style50">
                            <asp:Label ID="Label195" runat="server" Font-Names="Tahoma" Font-Size="8pt" Height="20px"
                                Text="ملاحظات" Width="37px"></asp:Label>
                        </td>
                        <td class="style33" colspan="3">
                            <asp:TextBox ID="txt_notes" runat="server" BorderColor="#CEE6FF" BorderStyle="Solid"
                                BorderWidth="1px" Font-Names="Tahoma" Font-Size="9pt" Height="21px" Width="729px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style49">
                    ...
                    <tr>
                        ...
                        <td class="style50" colspan="4">
                            ...
                            <asp:SqlDataSource ID="dts_donor" runat="server" ConnectionString="<%$ ConnectionStrings:con %>"
                                SelectCommand="SELECT top 10 [donor_id], [donor_namear], [donor_nameen] FROM [donor_data]">
                            </asp:SqlDataSource>
                    ...
                    <tr>
                        <td class="style50" style="border: thin solid #C0C0C0">
                            &nbsp;
                        </td>
