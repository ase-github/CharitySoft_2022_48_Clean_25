...
#Region "Events"
    ...
    Protected Sub SqlDataSource_waqf_donor_receipts_create_view_Donor_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceSelectingEventArgs) Handles SqlDataSource_project_donor_receipts_create_view_Donor.Selecting

        If Not IsPostBack Then

            Dim query_Search = "SELECT {0} FROM project_donor_receipts_create_view WHERE (donation_value >=  ISNULL(donation_standard_value, 0)) "

            If Not Session("project_donor_receipts_create_view") Is Nothing Then

                query_Search += Session("project_donor_receipts_create_view").ToString
    ...
    Protected Sub SqlDataSource_waqf_donor_receipts_create_view_SharingDonor_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceSelectingEventArgs) Handles SqlDataSource_project_donor_receipts_create_view_SharingDonor.Selecting
    ...
    '    'SqlDataSource_alocate_project.InsertParameters("current_flag").DefaultValue = Session("current_flag")
    '    'SqlDataSource_alocate_project.InsertParameters("aloc_bat").DefaultValue = Session("batch_id")
    '    'SqlDataSource_alocate_project.Insert()
