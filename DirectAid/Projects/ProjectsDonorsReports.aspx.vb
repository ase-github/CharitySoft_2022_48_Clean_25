...
Public Class ProjectsDonorsReports
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim str As String = " SELECT TOP 1 *, (SELECT collect_namear FROM collectors_tab WHERE collect_id='" & Session(SessionKey.USERNAME) & "') AS CreatedBy FROM VIW_ProjectsDonorsReports WHERE Maxproject_progress_id=(SELECT MAX(project_progress_id) FROM project_progress WHERE project_id ='" & Request.QueryString("project_id") & "') AND donor_id ='" & Request.QueryString("DonorID") & "' "
        With cmd
            .CommandTimeout = 60
            .Connection = con
        ...
        Try
            ...
            Dim ReportPath = ".\ConstructionReportWater.rpt"
