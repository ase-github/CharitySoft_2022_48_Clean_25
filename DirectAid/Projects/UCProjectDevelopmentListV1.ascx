<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCProjectDevelopmentListV1.ascx.vb"
    Inherits="DirectAid.UCProjectDevelopmentListV1" %>
...
<script type="text/javascript">
    ...
    function OpenProject(e) {
        ...
        //window.location.href = "UIProjectDevelopment.aspx?project_id=" + ASPxGridView1.GetRowKey(e.visibleIndex);
        var url = "UIProjectDevelopment.aspx?project_id=" + ASPxGridView1.GetRowKey(e.visibleIndex);
