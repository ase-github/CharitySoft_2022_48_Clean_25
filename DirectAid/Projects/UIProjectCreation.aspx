<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UIProjectCreation.aspx.vb"
    Inherits="DirectAid.UIProjectCreation" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AllocateProject_End(e) {
            //            var url = "UI_projects_approval_view.aspx?current_flag=" + e.result;
	...
	Cancel_End(e);
                ...
                <table width="100%" cellpadding="2px">
                    <tr>
                        ...
                        <td align="center" style="width: 16%;">
                            <dx:ASPxButton ID="ASPxButton_alocate_project" runat="server" Text="ربط المشاريع بالمتبرعين"
                                Width="100%" AutoPostBack="False" ClientInstanceName="ASPxButton_alocate_project"
                                ...
                                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1"
                                    ...
                                    <Columns>
                                        <dx:GridViewDataTextColumn Caption="رقم المشروع" FieldName="project_id" ReadOnly="false"
                                            ...
                                            <DataItemTemplate>
                                                <a href='UIProject.aspx?project_id=<%# Eval("project_id") %>' target="_blank">
                                                    <%# Eval("project_id")%></a>
                                            </DataItemTemplate>
                                        </dx:GridViewDataTextColumn>
...
<%--                                        <dx:GridViewCommandColumn ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="0"
                        ...
                        <tr>
                            <td align="center" colspan="3">
                                <asp:Label ID="lbl_followers0" runat="server" Text="المتبرعون" Width="100%" Font-Bold="True"></asp:Label>
                            </td>
                            <td align="center" colspan="3">
                                <asp:Label runat="server" Text="مساهمات المتبرعين" Width="100%" ID="lbl_followers"
                        ...
                        <tr valign="top">
                            ...
                            <td align="center" style="width: 35%;" rowspan="6" valign="top">
                                ...
                                <dx:ASPxGridView ID="ASPxGridView_Donor" runat="server" AutoGenerateColumns="False"
                                    ClientInstanceName="ASPxGridView_Donor" EnableCallBacks="true" DataSourceID="SqlDataSource_project_donor_receipts_create_view_Donor"
		...
		Calculate_Donor(s, e);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="الاسم" FieldName="donor_namear" ShowInCustomizationForm="True"
                                            VisibleIndex="1" Width="40%" SortIndex="0" SortOrder="Ascending">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataDateColumn Caption="التاريخ" ShowInCustomizationForm="True" UnboundType="DateTime"
                                            VisibleIndex="4" Width="15%">
                                        </dx:GridViewDataDateColumn>
                                        <dx:GridViewDataTextColumn Caption="الدوله" FieldName="nat_descrar" VisibleIndex="5"
                                            Width="20%">
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                    <SettingsBehavior ConfirmDelete="True" EnableCustomizationWindow="True" />
                            ...
                            <td align="center" style="width: 35%;" rowspan="6" valign="top">
                                ...
                                <dx:ASPxGridView ID="ASPxGridView_SharingDonor" runat="server" AutoGenerateColumns="False"
                                    ClientInstanceName="ASPxGridView_SharingDonor" EnableCallBacks="true" DataSourceID="SqlDataSource_project_donor_receipts_create_view_SharingDonor"
                                    RightToLeft="True" Width="100%" KeyFieldName="reciept_num">
                                    <ClientSideEvents SelectionChanged="function(s, e) {
    ...
    <asp:SqlDataSource ID="SqlDataSource_project_create_temp" runat="server" ConnectionString="<%$ ConnectionStrings:CharitySystemConnectionString %>"
        OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM VIEW_project WHERE (batch_id = @batch_id)"
    ...
    <asp:SqlDataSource ID="SqlDataSource_project_donor_receipts_create_view_Donor" runat="server"
        ConnectionString="<%$ ConnectionStrings:CharitySystemConnectionString %>" OldValuesParameterFormatString="original_{0}"
        SelectCommand="SELECT * FROM [project_donor_receipts_create_view]"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource_project_donor_receipts_create_view_SharingDonor"
        runat="server" ConnectionString="<%$ ConnectionStrings:CharitySystemConnectionString %>"
        OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [project_donor_receipts_create_view]">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource_waqf_proj_aloc_temp" runat="server" ConnectionString="<%$ ConnectionStrings:CharitySystemConnectionString %>"
        InsertCommandType="StoredProcedure" InsertCommand="proj_alloc_init" UpdateCommandType="Text"
    ...
    <asp:SqlDataSource ID="SqlDataSource_alocate_project" runat="server" ConnectionString="<%$ ConnectionStrings:CharitySystemConnectionString %>"
        InsertCommandType="StoredProcedure" InsertCommand="alocate_project">
        <InsertParameters>
